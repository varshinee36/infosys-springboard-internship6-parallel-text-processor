...
# ── Ensure stopwords are available (IMPORTANT FIX) ────────────────────────────
try:
...
# ── REAL-TIME CLEANING (NEW) ─────────────────────────────────────────────────
def clean_text_realtime(text):
    """
    Clean a single live message (used in dashboard real-time input)
    """
